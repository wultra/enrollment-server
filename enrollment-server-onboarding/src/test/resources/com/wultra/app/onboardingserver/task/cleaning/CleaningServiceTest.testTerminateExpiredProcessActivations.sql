...
INSERT INTO es_onboarding_process(id, process_config_id, identification_data, status, error_score, custom_data, timestamp_created) VALUES
    ('11111111-df91-4053-bb3d-3970979baf5d', 1, '{}', 'ACTIVATION_IN_PROGRESS', 0, '{}', now() - interval '301' second),
    ('22222222-df91-4053-bb3d-3970979baf5d', 1, '{}', 'ACTIVATION_IN_PROGRESS', 0, '{}', now() - interval '301' second),
    ('33333333-df91-4053-bb3d-3970979baf5d', 1, '{}', 'ACTIVATION_IN_PROGRESS', 0, '{}', now() - interval '301' second),
    ('44444444-df91-4053-bb3d-3970979baf5d', 1, '{}', 'ACTIVATION_IN_PROGRESS', 0, '{}', now()); -- to be kept
