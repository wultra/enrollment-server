...
insert into es_onboarding_process (id, process_config_id, identification_data, activation_id, status, custom_data, timestamp_created, error_score)
values ( 'b9d4cf32-3e3c-4bb1-8f66-5a3c91fe2f8b', 1, '{}', 'b7717831-4ed3-4597-88c1-b4646b91a76f', 'VERIFICATION_IN_PROGRESS', '{}', now(), 0);
...
insert into es_onboarding_process (id, process_config_id, identification_data, activation_id, status, custom_data, timestamp_created, error_score)
values ( 'c3c2c4c1-2a84-4c6e-a8bd-4e3b824d5c91', 1, '{}', '8e4a0b0a-84f3-4c71-9cc0-c9ac7b3f6593', 'VERIFICATION_IN_PROGRESS', '{}', now(), 0);
