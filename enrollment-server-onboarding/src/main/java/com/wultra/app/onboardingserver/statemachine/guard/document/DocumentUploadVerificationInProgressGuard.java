...
/**
 * Guard to ensure ({@link IdentityVerificationPhase#DOCUMENT_UPLOAD}, {@link IdentityVerificationStatus#IN_PROGRESS}) status
 *
 * @author Lukas Lukovsky, lukas.lukovsky@wultra.com
 */
@Component
public class DocumentUploadVerificationInProgressGuard implements Guard<EnrollmentState, EnrollmentEvent> {
