...
/**
 * Guard to check verification pending flag.
 *
...
public class StatusVerificationPendingGuard implements Guard<OnboardingState, OnboardingEvent> {
    ...
    public static final String KEY_VERIFICATION_PENDING = "verification_pending";
    ...
    public boolean evaluate(StateContext<OnboardingState, OnboardingEvent> context) {
        ...
        return Boolean.TRUE.equals(variables.get(KEY_VERIFICATION_PENDING));
    }
}
