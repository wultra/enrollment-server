...
/**
 * Guard to check rejected flag.
 *
 * @author Lukas Lukovsky, lukas.lukovsky@wultra.com
 * @author Lubos Racansky, lubos.racansky@wultra.com
 */
@Component
public class StatusRejectedGuard implements Guard<OnboardingState, OnboardingEvent> {
    ...
    public boolean evaluate(StateContext<OnboardingState, OnboardingEvent> context) {
        ...
        return Boolean.TRUE.equals(variables.get(KEY_REJECTED));
    }
}
