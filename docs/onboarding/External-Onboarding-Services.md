...
| `result`                                           | `Integer` | Outcome of the verification check on scale 0-10. |
...
NOTE: Currently triggered only in possitive result.
