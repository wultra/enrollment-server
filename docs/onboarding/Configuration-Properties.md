...
| `logging.pattern.console` | [See application.properties](../../enrollment-server-onboarding/src/main/resources/application.properties#L172) | Logging pattern for console which includes the correlation header value |
