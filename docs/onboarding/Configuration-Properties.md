...
| `enrollment-server-onboarding.provider.innovatrics.documentVerificationConfiguration.documentCountries` | `CZE`                     | Expected country of issue of identification documents. If empty, all countries of issue are considered during classification. |
