...
| `enrollment-server-onboarding.document-verification.verificationOnSubmitEnabled` | `false` | Whether document verification on submit is enabled. It verifies each document side separately. |
