 ...
 */
@Repository
public interface SelfieRepository extends CrudRepository<SelfieEntity, Long> {

    Optional<SelfieEntity> findTopByIdentityVerificationOrderByTimestampCreatedDesc(IdentityVerificationEntity identityVerification);
