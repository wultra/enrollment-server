...
public class DocumentVerificationEntity {
    ...
    /**
     * Default value for {@link #rejectReason} if the document provider omits details for a document of status {@link DocumentStatus#REJECTED}.
     */
    public static final String DEFAULT_REJECT_REASON = "Other";
