...
class ZenidDocumentVerificationProviderIntTest {

    private static final Logger logger = LoggerFactory.getLogger(ZenidDocumentVerificationProviderIntTest.class);
    ...
    private static byte[] readImageData(final String path) throws IOException {
        try (InputStream stream = ZenidDocumentVerificationProviderIntTest.class.getResourceAsStream(path)) {
            if (stream == null) {
