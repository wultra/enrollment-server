...
public class DocumentSubmitVerificationSyncTask {
     ...
     */
    @Scheduled(cron = "${enrollment-server.document-verification.checkDocumentSubmitVerifications.cron:0/15 * * * * *}", zone = "UTC")
    @SchedulerLock(name = "checkDocumentSubmitVerifications", lockAtMostFor = "5m")
