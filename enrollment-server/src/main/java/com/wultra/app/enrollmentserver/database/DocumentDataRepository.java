 ...
 */
@Repository
public interface DocumentDataRepository extends CrudRepository<DocumentData, String> {

    @Modifying
    int deleteAllByActivationId(String activationId);

    @Modifying
    @Query("DELETE FROM DocumentData d WHERE d.timestampCreated < :dateCleanup")
