 ...
 */
package com.wultra.app.enrollmentserver.interceptor;

import com.wultra.app.enrollmentserver.configuration.InterceptorConfiguration;
...
public class HttpCustomizationService {
    ...
    public MultiValueMap<String, String> getHttpHeaders() {
        ...
        final String correlationHeaderName = interceptorConfiguration.getCorrelationHeaderName();
