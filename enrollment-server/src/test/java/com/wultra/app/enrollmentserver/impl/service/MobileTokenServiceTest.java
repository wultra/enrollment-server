...
class MobileTokenServiceTest {
    ...
    void testOperationListForUser() throws Exception {
        ...
        final com.wultra.security.powerauth.client.model.response.v4.OperationListResponse response
                = new com.wultra.security.powerauth.client.model.response.v4.OperationListResponse();
