    ...
    return (
        <div>
            ...
            <div className="container">
                <nav className="navbar navbar-expand-lg navbar-dark bg-dark mt-3 rounded">
                    <a className="navbar-brand" href="#">
                        <img src="/images/wultra-square.svg" width="30" height="30" alt="Wultra Logo" className="mr-2"/>
                            <strong>Wultra Enrollment Server - iProov Demo</strong>
                    </a>
                </nav>
                                    ...
                                    <form>
                                        ...
                                        <button className="ml-1" type="submit">
                                            <Link href={{pathname: '/verify-token', query: {value: token}}} prefetch={false}>
                                                <a className="text-reset" target="_blank">Verify</a>
                                            </Link>
                                        </button>
                                    </form>
                                </div>
                    ...
                    <div className="col-sm-5">
                        <div className="card mb-3">
                            ...
                            <ul className="list-group list-group-flush">
                                <li className="list-group-item"><a target="_blank" href="https://wultra.com">🔗 Website</a></li>
            ...
            <footer className="container mt-3">
                <p>&copy; <span>2021</span> <a target="_blank" href="https://wultra.com">Wultra s.r.o.</a></p>
            </footer>
        </div>
    )
}
